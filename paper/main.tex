...
{\small\textit{v1.2. Added endpoint typology analysis: six structural properties\\
(autonomy, compositionality, state, determinism, scope, recursion depth)\\
that the equation cannot yet express. See CHANGELOG.md for details.\\
Previous version: \texttt{github.com/pranavlakherwal/smt-router/releases/tag/v1.1}}}
\end{center}
